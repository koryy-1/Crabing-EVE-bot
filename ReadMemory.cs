...
namespace read_memory_64_bit
{
    ...
    {
        static string RootAddress1;
        static int processId1;

        volatile static private bool AllowGetUITree = true;


        public static (IImmutableList<ulong>, IMemoryReader) GetRootAddressesAndMemoryReader(string RootAddress, int processId)
        {
            RootAddress1 = RootAddress;
        ...
        //var CheckNoResultsEntry = ReadMemory.GetUITrees(Window.RootAddress, Window.processId)
        //    .FindEntityOfStringByDictEntriesOfInterest("_name", "totalPriceLabel").handleEntityByDictEntriesOfInterest("_name", "totalPriceLabel");

        //var CheckNoResultsEntry = ReadMemory.GetUITrees(Window.RootAddress, Window.processId)
        //    .FindEntityOfString("InventoryPrimary").handleEntity("InventoryPrimary");

        //ReadMemory.SaveUITreeToFile(CheckNoResultsEntry, "InventoryPrimary");

        public static void SaveUITreeToFile(UITreeNode UiTree, string EntryName)
        {
